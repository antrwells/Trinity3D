...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DockArea_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_DockArea_t qt_meta_stringdata_DockArea = {
    {
        QT_MOC_LITERAL(0, 8)   // "DockArea"
    },
    "DockArea"
};
...
Q_CONSTINIT const QMetaObject DockArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DockArea.offsetsAndSizes,
    qt_meta_data_DockArea,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_DockArea_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DockArea, std::true_type>
    >,
    nullptr
} };
