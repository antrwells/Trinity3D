...
static constexpr auto qt_meta_stringdata_ToolBarWidget = QtMocHelpers::stringData(
    "ToolBarWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ToolBarWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ToolBarWidget_t qt_meta_stringdata_ToolBarWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ToolBarWidget[] = {
...
Q_CONSTINIT const QMetaObject ToolBarWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ToolBarWidget.offsetsAndSizes,
    qt_meta_data_ToolBarWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ToolBarWidget_t,
        // Q_OBJECT / Q_GADGET
