...
static constexpr auto qt_meta_stringdata_MaterialEditorWidget = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MaterialEditorWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MaterialEditorWidget_t qt_meta_stringdata_MaterialEditorWidget = {
    {
        QT_MOC_LITERAL(0, 20)   // "MaterialEditorWidget"
    },
    "MaterialEditorWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_MaterialEditorWidget[] = {
...
Q_CONSTINIT const QMetaObject MaterialEditorWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<ads::CDockWidget::staticMetaObject>(),
    qt_meta_stringdata_MaterialEditorWidget.offsetsAndSizes,
    qt_meta_data_MaterialEditorWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MaterialEditorWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MaterialEditorWidget, std::true_type>
    >,
    nullptr
} };
